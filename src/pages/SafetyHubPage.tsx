    ...
    <div className="flex-1 flex flex-col app-viewport bg-ah-canvas text-ah-text pb-20">
      ...
      <main className="flex-1 overflow-y-auto p-4 space-y-4">
        ...
        <div className="bg-ah-surface border border-ah-border rounded-3xl overflow-hidden divide-y divide-ah-border/50 text-xs font-medium">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-ah-text font-semibold">Blocked Contacts</div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-ah-text font-semibold">Muted Threads</div>
                <div className="text-[11px] text-ah-muted">
        ...
        <div className="p-4 bg-ah-surface border border-ah-border rounded-3xl space-y-2 text-xs">
          <h3 className="font-semibold text-ah-text">Nocturnal Etiquette</h3>
          <ul className="space-y-1.5 text-ah-muted list-disc list-inside">
