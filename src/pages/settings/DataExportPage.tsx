      ...
      <main className="flex-1 overflow-y-auto p-4 space-y-5 max-w-md mx-auto w-full">
        ...
        <div className="p-4 bg-night-surface border border-night-border rounded-3xl space-y-3">
          <div className="space-y-1">
            <h3 className="text-xs font-semibold text-white">Full Application Data Export</h3>
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 py-3 px-4 bg-brand-600 hover:bg-brand-500 text-white rounded-xl text-xs font-semibold flex items-center justify-center gap-2 min-h-touch active:scale-95 transition-all shadow-md"
            >
            ...
            {exportJson && (
              <button
                ...
                className="py-3 px-4 bg-night-card hover:bg-night-hover border border-night-border text-brand-300 rounded-xl text-xs font-semibold flex items-center justify-center gap-2 min-h-touch active:scale-95 transition-all"
              >
          ...
          {exportJson && (
            <div className="pt-2 animate-slide-up">
              <div className="flex items-center justify-between text-[11px] text-night-muted pb-1 font-mono">
                <span>SIMULATED_DATA_STREAM</span>
                <span>{exportJson.length} bytes</span>
              </div>
              <pre className="p-3 bg-black/50 border border-night-border rounded-xl text-[10px] font-mono text-emerald-400 overflow-x-auto max-h-60 overflow-y-auto leading-tight select-text">
                {exportJson}
              </pre>
            </div>
          )}
            ...
            <div className="space-y-2 pt-2 animate-slide-up">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="flex-1 py-2.5 rounded-xl border border-night-border text-xs font-medium text-night-text min-h-touch"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="flex-1 py-2.5 rounded-xl bg-red-600 hover:bg-red-500 text-white text-xs font-semibold min-h-touch shadow"
                >
                  Confirm Reset
                </button>
              </div>
