    ...
    <div className="flex-1 flex flex-col app-viewport bg-night-bg text-night-text">
      ...
      <main className="flex-1 overflow-y-auto p-4 space-y-3">
        {mutedThreads.length === 0 ? (
          <div className="py-20 text-center text-night-muted space-y-2">
            <Bell className="w-8 h-8 mx-auto text-night-muted/40 mb-2" />
                ...
                >
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                      <div className="font-semibold text-xs text-white truncate">{title}</div>
