...
export const MessageComposer: React.FC<MessageComposerProps> = ({
  ...
  return (
    <div className="sticky bottom-0 z-30 w-full bg-[#191625]/95 backdrop-blur-xl border-t border-[#2E2742] pb-[max(env(safe-area-inset-bottom),10px)] select-none shadow-xl">
      {/* Replying Banner */}
      {replyingTo && (
        <div className="flex items-center justify-between px-4 py-2 bg-[#252038] border-b border-[#382D52] text-xs">
          <div className="flex flex-col min-w-0 pr-2">
            ...
            <span className="text-[#91819A] truncate text-[11px]">{replyingTo.content}</span>
          </div>
          <button
            type="button"
            onClick={onCancelReply}
            className="p-1 text-[#91819A] hover:text-[#F4EEF8] min-h-touch min-w-touch flex items-center justify-center"
      ...
      {/* Quick Emoji Drawer */}
      {showEmojiPicker && (
        <div className="px-3 py-2 border-b border-[#2E2742] flex items-center gap-2 overflow-x-auto no-scrollbar bg-[#211C30] animate-slide-up">
      ...
      <div className="flex items-end gap-2 px-3 pt-2.5">
        ...
        <button
          ...
          className="p-2.5 text-[#91819A] hover:text-[#F4EEF8] min-h-touch min-w-touch flex items-center justify-center rounded-full active:bg-[#211C30] transition-colors shrink-0"
        ...
        <button
          ...
          className={`p-2.5 min-h-touch min-w-touch flex items-center justify-center rounded-full transition-colors shrink-0 ${
            showEmojiPicker ? 'text-[#B979FF] bg-[#252038]' : 'text-[#91819A] hover:text-[#F4EEF8] active:bg-[#211C30]'
          }`}
        ...
        <div className="flex-1 min-w-0 bg-[#211C30] border border-[#2E2742] focus-within:border-[#B979FF] rounded-2xl px-3.5 py-2 transition-all">
          <textarea
            ref={textareaRef}
            rows={1}
            value={text}
            ...
            className="w-full bg-transparent text-[#F4EEF8] placeholder-[#91819A] text-sm resize-none outline-hidden leading-relaxed max-h-28 overflow-y-auto"
      ...
      {showAttachmentModal && (
        <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/60 backdrop-blur-xs p-3 animate-fade-in">
          <div className="w-full max-w-[400px] bg-[#191625] border border-[#2E2742] rounded-3xl p-4 shadow-2xl space-y-3 animate-slide-up">
            <h3 className="text-xs font-semibold text-[#91819A] tracking-wider uppercase font-mono">
            ...
            <div className="space-y-2">
              <button
                ...
                className="w-full p-3 rounded-xl bg-[#211C30] hover:bg-[#2B243E] flex items-center gap-3 min-h-touch text-left text-xs text-[#F4EEF8] transition-colors"
              >
                <FileCode className="w-4 h-4 text-[#8197FF]" />
                <div>
                  <div className="font-semibold">Hushrooms 2008 Archive Hash</div>
                  <div className="text-[10px] text-[#91819A]">Cryptographic checksum ref</div>
                </div>
              </button>
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-[10px] text-[#91819A]">432 Hz harmonic capture</div>
                </div>
              </button>
            </div>
            ...
            <button
              ...
              className="w-full py-3 rounded-xl border border-[#2E2742] text-[#91819A] hover:text-[#F4EEF8] font-medium text-xs min-h-touch active:bg-[#211C30]"
            >
              Cancel
            </button>
          </div>
