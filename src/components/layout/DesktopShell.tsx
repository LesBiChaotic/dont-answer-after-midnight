    ...
    <div className="app-viewport w-full bg-[#11101A] text-[#F4EEF8] flex flex-col items-center justify-between p-6 sm:p-12 relative overflow-hidden">
      ...
      <header className="w-full max-w-4xl flex items-center justify-between z-10">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 rounded-2xl bg-[#191625] hover:bg-[#211C30] border border-[#2E2742] hover:border-[#8197FF] text-xs font-semibold text-[#F4EEF8] transition-all shadow-md active:scale-95"
        >
          <Smartphone className="w-3.5 h-3.5 text-[#8197FF]" />
          <span>Launch Mobile Preview</span>
          <ArrowRight className="w-3 h-3 text-[#91819A]" />
        </button>
      </header>
      ...
      <main className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-12 gap-10 items-center my-auto py-8 z-10">
        <div className="md:col-span-7 space-y-6 text-left">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-[#211C30] border border-[#8197FF]/30 text-[#8197FF] text-xs font-semibold">
            <span className="w-2 h-2 rounded-full bg-[#8197FF] animate-pulse" />
            Designed Exclusively for Mobile Handsets
          </div>

          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight text-white leading-tight font-serif">
            A quiet sanctuary for after-midnight conversations.
          </h1>

          <p className="text-[#C9B9D2] text-sm sm:text-base leading-relaxed">
          ...
          <div className="flex flex-wrap gap-3 pt-2">
            ...
            <button
              type="button"
              onClick={onEnablePreview}
              className="flex items-center gap-2 px-5 py-3 rounded-2xl bg-[#191625] hover:bg-[#211C30] text-[#F4EEF8] border border-[#2E2742] text-xs sm:text-sm font-medium transition-all active:scale-95"
            >
              <Smartphone className="w-4 h-4 text-[#91819A]" />
              <span>Simulate 390×844 Mobile Device</span>
            </button>
          </div>

          <div className="pt-4 border-t border-[#2E2742] flex items-center gap-6 text-xs text-[#91819A]">
        ...
        <div className="md:col-span-5 flex flex-col items-center">
          <div className="w-full max-w-[280px] bg-[#191625] border border-[#2E2742] rounded-3xl p-6 shadow-2xl shadow-black/80 flex flex-col items-center text-center space-y-4">
            <div className="w-48 h-48 bg-[#11101A] rounded-2xl border border-[#2E2742] flex flex-col items-center justify-center p-3 relative group">
            ...
            <div className="space-y-1">
              ...
              <p className="text-[11px] text-[#91819A]">Open your mobile camera to launch the native PWA view.</p>
            </div>
          </div>
        </div>
      </main>
      ...
      {/* Footer */}
      <footer className="w-full max-w-4xl text-center text-xs text-[#91819A] z-10 font-mono">
