    ...
    <div className="p-4 bg-night-surface border border-night-border rounded-3xl space-y-4 select-none">
      <div className="flex items-center justify-between border-b border-night-border/60 pb-2.5">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-xs font-semibold text-white">Legacy Client Protocol Match</h3>
        </div>
      ...
      {isFinished ? (
        <div className="text-center py-4 space-y-3">
          <h4 className="text-sm font-bold text-white">Matching Completed!</h4>
          ...
          <button
            ...
            className="px-4 py-2 bg-brand-600 hover:bg-brand-500 text-white rounded-xl text-xs font-semibold mx-auto min-h-touch"
          >
            Play Again
          </button>
        </div>
        ...
        <div className="space-y-3">
          <div className="p-3.5 bg-night-card border border-night-border rounded-2xl space-y-1.5">
          ...
          <p className="text-[11px] font-semibold text-night-muted">
